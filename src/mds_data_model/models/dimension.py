...
class Dimension(MDSModel):
    ...
    dimension_measured_part: Annotated[str | None, ControlledVocab] = Field(None,
        description="The part of an object measured.",
    )
    dimension_value: DimensionValue | float | int | None = Field(None,
        description="The numeric value of the measurement of a Dimension.",
    )
    dimension_measurement_unit: Annotated[str | None, ControlledVocab] = Field(None,
        description="The unit of measurement used when measuring a Dimension.",
    )
    dimension_value_qualifier: str | None = Field(None,
