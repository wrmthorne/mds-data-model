...
class Acquisition(MDSModel):
    ...
    acquisition_date: OneOrMany[Date | DateStringISO] = Field(
        None,
        description="The date on which title to an object or group of objects is transferred to the organisation.",
    )
    acquisition_funding: OneOrMany[AcquisitionFunding | str] = Field(
        None,
    ...
    transfer_of_title_number: OneOrMany[str] = Field(
        None,
...
class AcquisitionAuthoriser(Person):
    ...
    acquisition_authorisation_date: Date | DateStringISO | None = Field(
        None,
...
class AcquisitionFundingSourceOrganisation(Organisation):
    ...
    acquisition_funding_source_provisos: OneOrMany[str] = Field(
        None,
...
class OriginalObjectPurchasePrice(MDSModel):
    ...
    original_object_purchase_price_denomination: OneOrMany[str] = Field(
        None,
